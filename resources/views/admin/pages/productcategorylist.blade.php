...
@section('content')
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable">
                                        ...
                                        @foreach ($productcategory as $val)
                                                ...
                                                <td><a href="{{ url('admin/editproductcategory/'.$val->id) }}"  class="btn btn-gradient-ibiza waves-effect waves-light m-1 .btn-small" > <i class="fa fa-edit"></i> <span>Edit</span></a></td>
 ...
 $(document).on('click','.delete',function(){
   //alert('alert');
    ...
    var url = "{{ url('admin/deleteproductcategory') }}"+"/"+id;
    //alert(url);
