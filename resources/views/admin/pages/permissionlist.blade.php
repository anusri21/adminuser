...
@section('content')
     <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    ...
                                    <a href="{{url('admin/addpermission')}}"><button type="button" class="btn btn-box-tool" ><b>ADD</b><i class="fa fa-plus-circle"></i></button></a>
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable">
                                        ...
                                        @foreach ($user as $val)
                                                ...
                                                <td><a href="{{ url('admin/editpermission/'.$val->id) }}"  class="btn btn-gradient-ibiza waves-effect waves-light m-1 .btn-small" > <i class="fa fa-edit"></i> <span>Edit</span></a></td>
 ...
 $(document).on('click','.delete',function(){
   //alert('alert');
    ...
    var url = "{{ url('admin/deletepermission') }}"+"/"+id;
    //alert(url);
